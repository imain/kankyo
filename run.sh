...
sudo docker run --name kankyo --privileged --net=host --rm=true -v /run:/run -v /:/host -v /opt:/opt -v /usr/bin/atomic:/usr/bin/atomic -v /bin/docker:/bin/docker -v /sys:/sys -v /lib/modules:/lib/modules:ro -v /var/lib/libvirt:/var/lib/libvirt -v /var/log:/var/log -v /dev/null:/var/run/dbus/system_bus_socket -ti imain/kankyo:v2
